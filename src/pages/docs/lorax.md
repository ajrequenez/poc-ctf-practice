---
title: Empty Lorax (150)
description: Quidem magni aut exercitationem maxime rerum eos.
---

 It seems a USB drive fell out of the Cat and the Hat's hat.
    Sally picked it up and found a file on it.
    She is going to reverse it. Maybe you can help.

FILE: {% button variant="primary" href="/files/rev2" %}Rev2{% /button %}
